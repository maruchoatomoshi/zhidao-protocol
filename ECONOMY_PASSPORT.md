...
> Это паспорт экономики **сезона 1 (Пекин)**. Принципы экономики V4 Hainan
> (без пассивного дохода, витрина дня, траты внутри игр, общие цели группы,
> финал, панель экономики) — `V4_GAMES.md` §5.
