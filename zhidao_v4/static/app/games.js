...
(function () {
  ...
  "royale": {
    "title": "Протокол 60",
    "rules": [
      "Войдите в игру и дождитесь старта ведущего. Следите за временем: неверный или пропущенный ответ приводит к выбыванию.",
      "После ответа дождитесь разбора. Выбывшие наблюдают за партией; возможность возвращения и её цена показываются отдельно, если доступны.",
      "Итог и награды определяет сервер. Возвращение в приложение не начинает новую попытку."
    ],
    "steps": [
      {
        "text": "Вопрос ещё не появился. Что делать?",
        "options": [
          "Дождаться старта ведущего",
          "Многократно нажимать вход"
        ],
        "correct": 0,
        "why": "Игра начинается по команде ведущего."
      },
      {
        "text": "Вы отправили ответ и потеряли связь.",
        "options": [
          "Считать себя победителем",
          "Вернуться и проверить состояние"
        ],
        "correct": 1,
        "why": "Сохранённый ответ и итог нужно получить с сервера."
      },
      {
        "text": "Время ответа истекло.",
        "options": [
          "Дождаться результата раунда",
          "Ответить без ограничения времени"
        ],
        "correct": 0,
        "why": "Пропуск ответа может привести к выбыванию."
      }
    ]
  },
  "agent": {
    "title": "Тайный агент",
    "rules": [
      "Читайте личную цель и миссию. Чужие цели не показываются; не просите соседей раскрыть экран.",
      "Выполняйте только описанное безобидное действие. Для миссии с подтверждением цель должна подтвердить событие; некоторые миссии учитываются автоматически.",
      "Проверяйте результат в приложении. При раскрытии агента или выполнении миссии цель может измениться."
    ],
    "steps": [
      {
        "text": "Можно показать свою цель всей группе?",
        "options": [
          "Нет, это личная информация игры",
          "Да, так проще выиграть"
        ],
        "correct": 0,
        "why": "Секретность — часть игры."
      },
      {
        "text": "Миссия требует подтверждения цели.",
        "options": [
          "Подтвердить за другого",
          "Дождаться честного подтверждения"
        ],
        "correct": 1,
        "why": "Другой участник подтверждает действие сам."
      },
      {
        "text": "После миссии появилась новая цель.",
        "options": [
          "Прочитать новую миссию",
          "Продолжать прежнюю"
        ],
        "correct": 0,
        "why": "Актуальное задание показывает сервер."
      }
    ]
  },
  "market": {
    "title": "Рынок Контрабанды",
    "rules": [
      "Вступите в рынок в доступное время. Начальный набор выдаётся один раз; баланс рынка тестовый и отделён от ★.",
      "Составьте предложение: что отдаёте и что хотите получить. Покажите код партнёру. Перед принятием он проверяет товары и юани.",
      "Патруль проверяет сумки по правилам рынка. Итоги дня и награды подводит сервер; чужие сумки заранее не видны.",
      "Если связь пропала после действия, нажмите «Проверить результат». Просроченное предложение нужно создать заново."
    ],
    "steps": [
      {
        "text": "Код прислал знакомый. Можно сразу принять?",
        "options": [
          "Сначала проверить товары и сумму",
          "Да, содержимое неважно"
        ],
        "correct": 0,
        "why": "Принятие переводит согласованные товары и юани."
      },
      {
        "text": "Ответ после сделки потерялся.",
        "options": [
          "Создать другую сделку наугад",
          "Проверить результат прежнего действия"
        ],
        "correct": 1,
        "why": "Повтор с прежним ключом не списывает товары второй раз."
      },
      {
        "text": "Можно заранее просмотреть чужую сумку?",
        "options": [
          "Нет",
          "Да"
        ],
        "correct": 0,
        "why": "Чужой инвентарь приватен."
      }
    ]
  },
  "sabotage": {
    "title": "Саботаж",
    "rules": [
      "Дождитесь старта и прочитайте свою роль. Экипаж выполняет задания станций, саботажники мешают по доступным игровым действиям.",
      "На собрании обсуждайте наблюдения и голосуйте в приложении. Не показывайте тайные роли соседям.",
      "Используйте только разрешённые места, ходите спокойно. GPS-станции не считаются проверенными, пока организатор не подтвердит их на местности."
    ],
    "steps": [
      {
        "text": "Экран показывает тайную роль.",
        "options": [
          "Прочитать её самому",
          "Показать всей группе"
        ],
        "correct": 0,
        "why": "Иначе исчезает смысл поиска саботажника."
      },
      {
        "text": "Началось собрание.",
        "options": [
          "Узнать чужие роли из приложения",
          "Обсудить наблюдения и проголосовать"
        ],
        "correct": 1,
        "why": "Голосование опирается на обсуждение, не на раскрытые секреты."
      },
      {
        "text": "Станция недоступна или не подтверждена.",
        "options": [
          "Обратиться к организатору",
          "Обойти проверку GPS"
        ],
        "correct": 0,
        "why": "Не нужно обходить ограничения безопасного запуска."
      }
    ]
  },
  "zombie": {
    "title": "Зомби-протокол",
    "rules": [
      "Прочитайте свою сторону после старта: люди или зомби. Люди стараются продержаться, зомби заражают по правилам раунда.",
      "Это спокойная игра в согласованной зоне: без бега, толчков и хватания. Игровое касание плеча и код используются только по правилам организатора.",
      "Возможность вакцинации показывается в игре. Не идите к неподтверждённой станции и не обходите GPS-ограничения."
    ],
    "steps": [
      {
        "text": "Как перемещаться во время игры?",
        "options": [
          "Спокойно, в согласованной зоне",
          "Бежать через дорогу"
        ],
        "correct": 0,
        "why": "Безопасность важнее результата."
      },
      {
        "text": "Можно схватить другого участника?",
        "options": [
          "Да, ради победы",
          "Нет"
        ],
        "correct": 1,
        "why": "Допустимо только оговорённое лёгкое касание."
      },
      {
        "text": "Сторона изменилась после проверки.",
        "options": [
          "Прочитать новое состояние",
          "Игнорировать изменение"
        ],
        "correct": 0,
        "why": "Сторону и результат подтверждает сервер."
      }
    ]
  },
  "capture": {
    "title": "Захват кампуса",
    "rules": [
      "Откройте карту: ваша фракция и доступные действия показаны в приложении.",
      "Для действий у точек нужны подходящее время, GPS и ответ на вопрос. Дуэль имеет отдельный результат.",
      "Неподтверждённые точки не являются разрешением на игру. Не заходите в закрытые зоны; при неточном GPS подождите на безопасном открытом месте."
    ],
    "steps": [
      {
        "text": "GPS показывает неточное место.",
        "options": [
          "Подождать на безопасном открытом месте",
          "Подменить координаты"
        ],
        "correct": 0,
        "why": "Проверка положения нужна для честной игры."
      },
      {
        "text": "Точка находится за закрытой дверью.",
        "options": [
          "Пройти любой ценой",
          "Не входить, сообщить организатору"
        ],
        "correct": 1,
        "why": "Игровая цель не отменяет правила кампуса."
      },
      {
        "text": "Вы ответили на вопрос.",
        "options": [
          "Дождаться подтверждения захвата",
          "Считать точку своей сразу"
        ],
        "correct": 0,
        "why": "Владельца определяет сервер."
      }
    ]
  },
  "workshop": {
    "title": "Мастерская",
    "rules": [
      "Откройте «Ещё → Мастерская». Каждый рецепт заранее показывает, во что превратится предмет — исход не случаен.",
      "Нужно ровно четыре одинаковых — все четыре уходят в переплавку, звёзды не списываются.",
      "Новый предмет появится после подтверждения сервера. Обучение не переплавляет реальные предметы."
    ],
    "steps": [
      {
        "text": "Перед переплавкой нужно…",
        "options": [
          "Проверить, каких предметов и сколько хватает",
          "Нажать не читая"
        ],
        "correct": 0,
        "why": "Рецепт показывает итог до подтверждения."
      },
      {
        "text": "Сколько одинаковых предметов остаётся у вас после переплавки?",
        "options": [
          "Один",
          "Ни одного"
        ],
        "correct": 1,
        "why": "Все четыре уходят в переплавку; новый предмет — один."
      },
      {
        "text": "Запрос ещё выполняется.",
        "options": [
          "Дождаться результата",
          "Решить, что приз уже выдан"
        ],
        "correct": 0,
        "why": "Декорация не определяет награду."
      }
    ]
  },
  "story": {
    "title": "Скрытые файлы",
    "rules": [
      "Открывайте доступные фрагменты истории, читайте документы и подсказки.",
      "Часть фрагментов зависит от дня или исследования мест. Закрытый фрагмент не означает ошибку приложения.",
      "Ответы проверяются сервером. Обучение не содержит ответов настоящего сценария и ничего не открывает в нём."
    ],
    "steps": [
      {
        "text": "Фрагмент откроется позже.",
        "options": [
          "Вернуться в указанный день",
          "Искать секретный ответ в обучении"
        ],
        "correct": 0,
        "why": "Доступ зависит от условий истории."
      },
      {
        "text": "Найдена подсказка.",
        "options": [
          "Считать историю завершённой",
          "Прочитать и сопоставить с документами"
        ],
        "correct": 1,
        "why": "Находка — часть расследования."
      },
      {
        "text": "Можно взять ответ сценария из этой тренировки?",
        "options": [
          "Нет",
          "Да"
        ],
        "correct": 0,
        "why": "Учебные примеры отделены от настоящей истории."
      }
    ]
  },
  "map": {
    "title": "Туман и метки",
    "rules": [
      "Туман отражает исследование карты, а не запрет физического прохода. Соблюдайте реальные ограничения кампуса.",
      "Для исследования приложение запрашивает местоположение. Плохая точность может помешать засчитать точку.",
      "Метки используют готовые обозначения. Перед платным действием проверьте стоимость; метки не раскрывают историю перемещений автора."
    ],
    "steps": [
      {
        "text": "Участок скрыт туманом.",
        "options": [
          "Ориентироваться на реальные правила прохода",
          "Считать его безопасным автоматически"
        ],
        "correct": 0,
        "why": "Карта не заменяет правила кампуса."
      },
      {
        "text": "GPS неточный.",
        "options": [
          "Засчитать любое место",
          "Дождаться более точного сигнала"
        ],
        "correct": 1,
        "why": "Неточные координаты не должны открывать случайную область."
      },
      {
        "text": "У метки указана цена.",
        "options": [
          "Прочитать подтверждение",
          "Считать все метки бесплатными"
        ],
        "correct": 0,
        "why": "Условия действия показаны перед отправкой."
      }
    ]
  },
    smuggle: {
      title: "Контрабанда",
      rules: ["3–6 игроков. По очереди каждый — таможенник BlueJoy, остальные — купцы. Торгуйтесь голосом: в приложении только выбор карт, товар из списка и число юаней.", "Купец тайно кладёт в сумку до 5 товаров и заявляет один разрешённый: «3 манго». Число товаров всегда честное, тип — как решите. Можно приложить взятку в игровых юанях.", "Таможенник пропускает сумку — взятка его — или вскрывает. Честная сумка, вскрытая зря, стоит таможне штрафов. Иначе отмеченная запрещёнка конфискуется со штрафом, неотмеченная проскальзывает, а ложная отметка стоит таможне.", "В режиме «Иероглифы» во вскрытой сумке видны только знаки — их нужно прочитать. Роли дают трюк раз за партию, события рынка меняют правила раунда.", "Итог: юани + товары на прилавке + король и королева рынка + полные наборы. Юани сгорают с партией; победитель партии от 4 игроков получает 10★ раз в день. Эта тренировка ничего не начисляет."],
      steps: [
        { text: "В сумке 2 манго и жемчуг. Что можно заявить?", options: ["«3 манго»", "«2 манго»"], correct: 0, why: "Число товаров всегда честное: в сумке три карты. Тип — ваш блеф." },
        { text: "Вы таможенник, вскрыли сумку «3 манго», а там три 芒果. Что будет?", options: ["Таможня платит штрафы купцу", "Купец платит штраф"], correct: 0, why: "芒果 — манго. Честная сумка, вскрытая зря, стоит таможне." },
        { text: "Во вскрытой сумке «2 риса» лежат 大米 и 珍珠. Какую карту отметить?", options: ["珍珠", "大米"], correct: 0, why: "大米 — рис, а 珍珠 — жемчуг, запрещёнка. Отметка честного товара стоит штрафа." }
      ]
    },
    outage: {
      title: "Сбой системы",
...
(function () {
  ...
  const POLL_MS = 2000;
  const TITLES = { spy: "Шпион Протокола", cipher: "Шифровальщики", outage: "Сбой системы", smuggle: "Контрабанда" };
  const renderers = {};
  ...
  function stopRestrictedMotion() {
    if (document.hidden || motionQuery.matches || document.documentElement.dataset.motion !== "full") {
  ...
  async function refresh() {
    ...
    try {
      const response = await api("/api/v4/games/rooms/current");
      ...
      clearTimeout(retryTimer);
      if (!document.hidden && onScreen()) retryTimer = setTimeout(refresh, POLL_MS);
    } finally {
      refreshing = false;
    }
  }
  ...
  function apply(data) {
    const quiet = quietRefresh || document.hidden || !onScreen();
    quietRefresh = false;
    if (quiet) phaseEntrance = false;
    ...
    if (key !== phaseKey) {
      phaseEntrance = !quiet && phaseKey !== null;
    ...
    if (quiet || next !== signature) {
      if (quiet) $("gameNote").textContent = "";
      signature = next;
      draw();
    }
    startPolling();
  ...
  document.addEventListener("visibilitychange", () => {
    quietRefresh = true;
    stopRestrictedMotion();
    if (document.hidden) stopPolling();
    else if (onScreen()) refresh();
  });
  window.addEventListener("online", () => {
    quietRefresh = true;
    if (!document.hidden && onScreen()) refresh();
  });
