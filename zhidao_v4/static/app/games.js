...
(function () {
  ...
  "workshop": {
    "title": "Мастерская",
    "rules": [
      "Откройте «Ещё → Мастерская». Доступные рецепты показывают нужные дубликаты и сбор ★.",
      "Перед подтверждением проверьте, что отдаёте. Последний экземпляр сохраняется; улучшение использует дубликаты.",
    ...
    "steps": [
      {
        ...
        "options": [
          "Проверить предметы и сбор",
          "Нажать не читая"
        ],
        "correct": 0,
        "why": "Рецепт показывает стоимость до подтверждения."
      },
      {
        "text": "Можно переплавить последний экземпляр?",
        "options": [
          "Да",
          "Нет"
        ],
        "correct": 1,
        "why": "Последний экземпляр остаётся в коллекции."
      },
      {
