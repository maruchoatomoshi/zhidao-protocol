...
_создана в 0001, колонки, ключи или индексы последний раз менялись в 0026_
...
_создана в 0008, колонки, ключи или индексы последний раз менялись в 0026_
...
- (season_id) → `v4_seasons`(id)

Индексы и уникальность:
- из определения таблицы: UNIQUE-ограничение — (code)
- `v4_game_rooms_activity_idx`: индекс — (last_activity_at)
- `v4_game_rooms_season_idx`: индекс — (season_id)
