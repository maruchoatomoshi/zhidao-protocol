...
const TIANHAO_PHRASES = [
  // День 1
  { day: 1, period: 0, chinese: '早上好', pinyin: 'Zǎoshang hǎo', russian: 'Доброе утро', note: 'Простое приветствие, с которого стоит начинать день' },
  ...
  // День 2
  { day: 2, period: 0, chinese: '几点开早饭？', pinyin: 'Jǐ diǎn kāi zǎofàn?', russian: 'Во сколько начинается завтрак?', note: 'Полезно узнать заранее, чтобы не проспать завтрак' },
  ...
  // День 3
  { day: 3, period: 0, chinese: '今天天气怎么样？', pinyin: 'Jīntiān tiānqì zěnmeyàng?', russian: 'Какая сегодня погода?', note: 'Хорошая фраза для лёгкого разговора утром' },
  ...
  // День 4
  { day: 4, period: 0, chinese: '今天的计划是什么？', pinyin: 'Jīntiān de jìhuà shì shénme?', russian: 'Какие планы на сегодня?', note: 'Удобно спросить с утра, чтобы быть в курсе' },
  ...
  // День 5
  { day: 5, period: 0, chinese: '我可以再睡一会儿吗？', pinyin: 'Wǒ kěyǐ zài shuì yíhuìr ma?', russian: 'Можно ещё немного поспать?', note: 'Шутливая фраза для самых сонных' },
  ...
  // День 6
  { day: 6, period: 0, chinese: '早饭有什么？', pinyin: 'Zǎofàn yǒu shénme?', russian: 'Что есть на завтрак?', note: 'Полезно, если меню не на русском' },
  ...
  // День 7
  { day: 7, period: 0, chinese: '我不吃鸡蛋', pinyin: 'Wǒ bù chī jīdàn', russian: 'Я не ем яйца', note: 'Пример фразы про предпочтения в еде — замени на своё' },
  ...
  // День 8
  { day: 8, period: 0, chinese: '有牛奶吗？', pinyin: 'Yǒu niúnǎi ma?', russian: 'Есть молоко?', note: 'На завтраке пригодится почти всегда' },
  ...
  // День 9
  { day: 9, period: 0, chinese: '我吃饱了', pinyin: 'Wǒ chī bǎo le', russian: 'Я сыт(а)', note: 'Вежливый способ сказать, что хватит еды' },
  ...
  // День 10
  { day: 10, period: 0, chinese: '今天几点集合？', pinyin: 'Jīntiān jǐ diǎn jíhé?', russian: 'Во сколько сегодня сбор?', note: 'Важно знать с самого утра' },
  ...
  // День 11
  { day: 11, period: 0, chinese: '别忘了带水', pinyin: 'Bié wàngle dài shuǐ', russian: 'Не забудь взять воду', note: 'Хорошая привычка перед выходом' },
  ...
  // День 12
  { day: 12, period: 0, chinese: '我准备好了', pinyin: 'Wǒ zhǔnbèi hǎo le', russian: 'Я готов(а)', note: 'Короткая и уверенная фраза перед выходом' },
  ...
  // День 13
  { day: 13, period: 0, chinese: '今天穿什么？', pinyin: 'Jīntiān chuān shénme?', russian: 'Что сегодня надеть?', note: 'Можно спросить про дресс-код или погоду' },
  ...
  // День 14
  { day: 14, period: 0, chinese: '我没有睡好', pinyin: 'Wǒ méiyǒu shuì hǎo', russian: 'Я плохо спал(а)', note: 'Полезно сказать, если чувствуешь себя не очень' },
  ...
  // День 15
  { day: 15, period: 0, chinese: '早上好，今天怎么样？', pinyin: 'Zǎoshang hǎo, jīntiān zěnmeyàng?', russian: 'Доброе утро, как дела сегодня?', note: 'Дружелюбное утреннее приветствие' },
  ...
  // День 16
  { day: 16, period: 0, chinese: '我可以晚一点到吗？', pinyin: 'Wǒ kěyǐ wǎn yìdiǎn dào ma?', russian: 'Можно прийти немного позже?', note: 'Спросить вежливо, если нужно задержаться' },
  ...
  // День 17
  { day: 17, period: 0, chinese: '还有时间吗？', pinyin: 'Hái yǒu shíjiān ma?', russian: 'Есть ещё время?', note: 'Полезно, если не успеваешь к началу' },
  ...
  // День 18
  { day: 18, period: 0, chinese: '大家都到了吗？', pinyin: 'Dàjiā dōu dào le ma?', russian: 'Все уже пришли?', note: 'Хорошая фраза для проверки сбора группы' },
  ...
  // День 19
  { day: 19, period: 0, chinese: '我们今天去哪儿？', pinyin: 'Wǒmen jīntiān qù nǎr?', russian: 'Куда мы сегодня идём?', note: 'Простой способ узнать маршрут дня' },
  ...
  // День 20
  { day: 20, period: 0, chinese: '早上好，新的一天开始了', pinyin: 'Zǎoshang hǎo, xīn de yì tiān kāishǐ le', russian: 'Доброе утро, начинается новый день', note: 'Хорошая фраза, чтобы настроиться на день' },
...
function _getCurrentHour() {
  const now = new Date();
  return parseInt(now.toLocaleString('en-US', { timeZone: 'Asia/Shanghai', hour: 'numeric', hour12: false }));
}

function _getCurrentPeriod() {
  const hour = _getCurrentHour();
  if (hour >= 7 && hour < 9) return 0; // завтрак
  if (hour >= 13 && hour < 16) return 1; // обед
  if (hour >= 18 && hour < 21) return 2; // ужин
  return null;
}
...
function getCurrentTianhaoPhrase() {
  ...
  if (day < 1 || day > 20 || period === null) return null;
...
function renderTianhaoPhraseCard() {
  ...
  if (!phrase) {
    const hour = _getCurrentHour();
    let next = 'завтра в 07:00';
    if (hour < 7) next = '07:00';
    else if (hour < 13) next = '13:00';
    else if (hour < 18) next = '18:00';
    el.innerHTML = `
      <div class="card-inner" style="padding:12px 14px;">
        ...
        <div style="font-size:11px;color:var(--text2);">Следующая фраза появится в ${next}</div>
      </div>`;
    return;
  }

  const periodLabel = period === 0 ? '07:00–09:00' : period === 1 ? '13:00–16:00' : '18:00–21:00';
  el.innerHTML = `
    <div class="card-inner" style="padding:12px 14px;cursor:pointer;" onclick="showTianhaoPopup(window._tianhaoCurrentPhrase)">
      <div style="font-size:9px;font-family:monospace;color:var(--text3);letter-spacing:1px;margin-bottom:8px;">孙天昊提示 // ФРАЗА ДНЯ · ДЕНЬ ${day} · ${periodLabel}</div>
