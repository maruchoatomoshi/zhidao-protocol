...
const LIZA_PHRASES = [
  ...
  'Внимание, отбой! Поймала бы тебя в коридоре в такое время — стояли бы у двери до утра. Выключай телефон',
  'Серьёзно? В это время положено спать, а не сидеть и залипать в игрульки. За пунктуальность баллов нет, а вот равновесие системы нарушено',
];
