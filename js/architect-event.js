...
const ARCHITECT_VICTORY_LINES = [
  ...
  'Трещина в Чёрном Заслоне — вот что вы сделали Стена держала дольше меня, но теперь дрогнула и она Радуйтесь, операторы, это не должно было случиться так рано'
];
